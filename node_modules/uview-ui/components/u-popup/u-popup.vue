		...
		style() {
			...
			if (this.mode == 'left' || this.mode == 'right') {
				style = {
					...
					height: '100%',
					transform: `translate3D(${this.mode == 'left' ? '-100%' : '100%'},0rpx,0rpx)`
				};
			} else if (this.mode == 'top' || this.mode == 'bottom') {
				style = {
					width: '100%',
					height: this.height ? this.getUnitValue(this.height) : this.getUnitValue(this.length),
					transform: `translate3D(0rpx,${this.mode == 'top' ? '-100%' : '100%'},0rpx)`
				};
			}
...
.u-drawer-content-visible {
	transform: translate3D(0rpx, 0rpx, 0rpx) !important;
}

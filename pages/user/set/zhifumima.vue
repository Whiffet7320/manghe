	...
	<view class="index">
		...
		<view v-else>
			...
			<u-message-input v-if='!isTwo && !isThree' :focus="true" :breathe="true" :maxlength='6' :dot-fill="true"
				@finish="finish"></u-message-input>
			<u-message-input v-if='isTwo && !isThree' :focus="true" :breathe="true" :maxlength='6' :dot-fill="true" @finish="finish2">
			</u-message-input>
			<u-message-input v-if='isTwo && isThree' :focus="true" :breathe="true" :maxlength='6' :dot-fill="true" @finish="finish3">
			</u-message-input>
		</view>

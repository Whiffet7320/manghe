		...
		<view class="nav3">
			...
			<view class="left">
				...
				<view class="time1">
					...
					<view class="t1">21</view>
					<view class="t3">:</view>
					<view class="t1">15</view>
					<view class="t3">:</view>
					<view class="t1">08</view>
				</view>
			</view>
			<view class="right">
				<view class="txt1">¥1180.00</view>
				<view class="txt2">¥ 2580.00</view>
			</view>
		</view>
		<view class="nav2">
			<view class="left">
				<view class="txt1">微针一年（不限次数）</view>
				<view class="txt2">1年</view>
			</view>
		</view>
		<view class="nav4">

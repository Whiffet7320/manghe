	...
	<view class="index">
		...
		<view class="nav2">
			...
			<view class="tit2 tit3">
				<view class="fk"></view>
				<view class="txt2-1">积分奖励分为五级：一级推荐(积分奖励等于充值购买金额的百分五);二级推荐(积分奖励等于充值购买金额的百分三);三级推荐(积分奖励等于充值购买金额的百分二);四级推荐(积分奖励等于充值购买金额的百分之一);五级推荐或以下（积分奖励等于充值购买金额的百分之零点五);</view>
			</view>
			<view class="txt1 txt3">{{txt2}}</view>
			<view class="tit2">
				<view class="fk"></view>
				<view class="txt2-1">购买使用积分时，积分需大于等于订单金额方可使用，1积分等于1元；充值积分等于充值金额的1/15，积分奖励隔天到账</view>
			</view>
			<view class="txt4">
